...
export const objectifList = [
  ...
  },
  {
    no: "2",
    title: "Data Analysis",
    subtitle: "Les animaux aident à réduire le stress, à apaiser les tensions et à améliorer la gestion des émotions au quotidien. Par le biais d'activités de soins ou d'interaction avec les animaux, les bénéficiaires gagnent en assurance et apprennent à prendre des initiatives."
  },
  {
    no: "3",
    title: "Finalize Product",
    subtitle: "En groupe, les séances favorisent la coopération, l'écoute, et la gestion des conflits à travers des activités communes."
  }
];
